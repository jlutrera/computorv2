...
bool help(char *newinput)
{
	...
	const char *help_text[] = {
		...
		"   -----------------------",
		"   Syntax: delete [var1] [var2] ...",
		"   Note: If no arguments are provided, this command deletes ALL stored variables.",
		"   Examples:",
		"     delete x y z    (delete the variables x, y, and z)",
		"     delete x        (delete the variable x)",
