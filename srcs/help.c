...
bool help(char *newinput)
{
	...
	const char *help_text[] = {
		...
		"   ----------------",
		"   Syntax: exit",
		"\n3. Clean the screen (as the 'clear' command does)",
		"   ----------------------------------------------",
		"   Syntax: clear",
		"\n4. Solve the given equation (linear, quadratic or cubic only)",
		"   ----------------------------------------------------------",
		...
		"\n6. Delete stored variables",
		"   -----------------------",
		"   Syntax: delete",
		"   Note: This command deletes ALL stored variables.",
		"\n7. List the variable values",
		"   ------------------------",
